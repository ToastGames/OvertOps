...
Shader "Amplify/HackerManWallMain"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 tex2DNode6 = tex2D( _Grid001, uv_Grid001 );
				...
				float4 temp_output_42_0 = ( ( _GlowExtra * tex2DNode6 * abs( ( 2 * temp_output_32_0 ) ) ) + ( tex2DNode6 + ( ( tex2DNode6 + ( tex2D( _Streaks1, panner18 ) * _Streaks1Multiplier ) + ( tex2D( _Streaks2, panner19 ) * _Streaks2Multiplier ) + ( tex2D( _Streaks3, panner20 ) * _Streaks3Multiplier ) + ( ( tex2D( _Texture0, ( temp_output_64_0 + appendResult71 + temp_output_115_0 ) ) * _Dots1Intensity ) + ( tex2D( _Texture0, ( temp_output_64_0 + appendResult85 + temp_output_115_0 ) ) * _Dots2Intensity ) + ( tex2D( _Texture0, ( temp_output_64_0 + appendResult92 + temp_output_115_0 ) ) * _Dots3Intensity ) + ( tex2D( _Texture0, ( temp_output_64_0 + appendResult100 + temp_output_115_0 ) ) * _Dots4Intensity ) ) ) + ( _ColourOverlay * temp_output_32_0 ) ) ) );
...
/*ASEBEGIN
Version=18400
1920;0;1920;1019;-454.5595;556.3165;1.872085;True;False
...
Node;AmplifyShaderEditor.SamplerNode;87;-1378.557,1617.306;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;False;0;False;-1;bb39363c50617c74da1c74169c11d499;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;99;-1379.729,2374.406;Inherit;True;Property;_TextureSample2;Texture Sample 0;0;0;Create;True;0;0;False;0;False;-1;bb39363c50617c74da1c74169c11d499;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;91;-1375.381,1991.842;Inherit;True;Property;_TextureSample1;Texture Sample 0;0;0;Create;True;0;0;False;0;False;-1;bb39363c50617c74da1c74169c11d499;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=A81EC0591A749B8CDC5C4571FFDA69BCA1502982